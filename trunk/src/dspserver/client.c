...
void readcb(struct bufferevent *bev, void *ctx){
    ...
    while (evbuffer_get_length(inbuf) >= MSG_SIZE) {
        ...
        } else if(strncmp(cmd,"setrxagcattack",14)==0) {
            int value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atoi(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagcdecay",13)==0) {
            int value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atoi(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagchang",12)==0) {
            int value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atoi(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagchanglevel",17)==0) {
            double value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atof(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagchangthreshold",21)==0) {
            int value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atoi(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagcthresh",14)==0) {
            double value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atof(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagctop",11)==0) {
            double value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atof(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxagcslope",13)==0) {
            int value;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            value = atoi(tokens[0]);
        ...
        } else if(strncmp(cmd,"setrxdcblockgain",14)==0) { // KD0OSS
            float gain;
            if (tokenize_cmd(&saveptr, tokens, 1) != 1)
                goto badcommand;
            gain=atof(tokens[0]);
