...
[ ] is there more stalling because I'm not periodically polling?
...
[ ] Rob Frohne's hermes is generating spikes all over the spectrum which
...
[ ] Get working connection status feedback.
