...
**
** Created: Sun Jan 13 22:03:20 2013
**      by: The Qt Meta Object Compiler version 67 (Qt 5.0.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../QtRadio/Filter.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Filter_t, stringdata) + ofs \
...
const QMetaObject Filter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Filter.data,
      qt_meta_data_Filter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Filter.stringdata))
