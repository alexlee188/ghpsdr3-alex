...
public:
    ...
    void setupUi(QMainWindow *UI)
    {
        ...
        spectrumFrame->setMaximumSize(QSize(16777215, 256));
        ...
        sizePolicy.setHeightForWidth(waterfallFrame->sizePolicy().hasHeightForWidth());
        waterfallFrame->setSizePolicy(sizePolicy);
        waterfallFrame->setMinimumSize(QSize(927, 0));
