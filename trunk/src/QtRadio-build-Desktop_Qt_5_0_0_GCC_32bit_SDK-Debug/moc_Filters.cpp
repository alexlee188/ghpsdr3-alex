...
**
** Created: Sun Jan 13 22:03:19 2013
**      by: The Qt Meta Object Compiler version 67 (Qt 5.0.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../QtRadio/Filters.h"
...
QT_MOC_LITERAL(8, 93, 9)
    ...
    "Filters\0filtersChanged\0\0FiltersBase*\0"
    "previousFilters\0newFilters\0filterChanged\0"
    "previousFitler\0newFilter\0"
};
...
void Filters::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->filtersChanged((*reinterpret_cast< FiltersBase*(*)>(_a[1])),(*reinterpret_cast< FiltersBase*(*)>(_a[2]))); break;
        case 1: _t->filterChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (Filters::*_t)(FiltersBase * , FiltersBase * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filters::filtersChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (Filters::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filters::filterChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject Filters::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Filters.data,
