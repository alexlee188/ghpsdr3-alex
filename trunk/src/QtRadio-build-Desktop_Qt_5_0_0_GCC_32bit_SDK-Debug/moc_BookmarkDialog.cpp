...
#include "../QtRadio/BookmarkDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BookmarkDialog_t, stringdata) + ofs \
...
const QMetaObject BookmarkDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BookmarkDialog.data,
      qt_meta_data_BookmarkDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BookmarkDialog.stringdata))
